...
import { LayoutGrid, Network, Mic2, MessageSquare, BookOpen, Menu, Sparkles, Image as ImageIcon, GraduationCap, Globe, X, LogOut, Lightbulb, Timer, Calculator, Sword } from 'lucide-react';
...
import { View, UserStats, LanguageCode } from './types';
import { LANGUAGES, TRANSLATIONS } from './constants';
import { getStats, saveStats, updateActivity, calculateLevel, resetData } from './services/storageService';
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (timerActive && timeLeft > 0) {
        ...
        // Maybe play a sound here in future
    }
  ...
  const renderContent = () => {
    switch (currentView) {
      case View.DASHBOARD: return <Dashboard stats={stats} onNavigate={setCurrentView} language={language} updateStats={updateStatsWrapper}/>;
      ...
      default: return <Dashboard stats={stats} onNavigate={setCurrentView} language={language} updateStats={updateStatsWrapper}/>;
    }
  };
    ...
    <div className="flex h-[100dvh] bg-[#f8fafc] overflow-hidden font-sans">
      ...
      `}>
        ...
        <div className="p-4 border-t border-slate-100 space-y-2">
           ...
           <button 
             onClick={() => { if(confirm(t.resetApp + "?")) resetData(); }}
